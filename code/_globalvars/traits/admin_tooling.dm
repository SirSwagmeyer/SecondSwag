...
GLOBAL_LIST_INIT(admin_visible_traits, list(
	...
	/mob = list(
		...
		"TRAIT_IMMUNE_TO_DOMINATE" = TRAIT_IMMUNE_TO_DOMINATE, // DARKPACK EDIT ADD - POWERS - (Dominate)
		"TRAIT_IMMUNE_TO_PRESENCE" = TRAIT_IMMUNE_TO_PRESENCE, // DARKPACK EDIT ADD - POWERS - (Presence)
		"TRAIT_TRUE_FAITH" = TRAIT_TRUE_FAITH, // DARKPACK EDIT ADD
		"TRAIT_RESIST_DOMINATE" = TRAIT_RESIST_DOMINATE, // DARKPACK EDIT ADD - POWERS - (Dominate)
		"TRAIT_RESIST_PRESENCE" = TRAIT_RESIST_PRESENCE, // DARKPACK EDIT ADD - POWERS - (Presence)
