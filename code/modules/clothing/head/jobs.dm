...
/obj/item/clothing/head/hats/caphat/parade
	name = "parade cap (royal blue)" //DARKPACK EDIT CHANGE - ORIGINAL: name = "captain's parade cap"
	desc = "Worn only by those with an abundance of class." //DARKPACK EDIT CHANGE - ORIGINAL: desc = "Worn only by Captains with an abundance of class."
	icon_state = "capcap"
	dog_fashion = null

/obj/item/clothing/head/hats/caphat/bicorne
	name = "royal bicorne" //DARKPACK EDIT CHANGE - ORIGINAL: name = "captain's bicorne"
